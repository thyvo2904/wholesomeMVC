<%@ Page Language="C#" AutoEventWireup="True" Inherits="inventory_admin" Codebehind="inventory_admin.aspx.cs" %>
...
<nav class="navbar navbar-default" role="navigation">
 ...
 <div class="container-fluid">
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="userdropdown">
      ...
      <li role="presentation"><a role="menuitem" tabindex="4" onserverclick="btnlogout_click" href="index.aspx" runat="server">Log Out</a></li>
    </ul>      
         </div>   
